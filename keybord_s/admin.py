...
admin_menu_main.row(InlineKeyboardButton(text='Франшиза🧩', callback_data='franchise_settings_admin'))
...
#меню франшизы#
admin_menu_franchise=InlineKeyboardMarkup(row_width=2)
admin_menu_franchise.row(InlineKeyboardButton(text='Добавить➕', callback_data='franchise_add_admin'))
admin_menu_franchise.insert(InlineKeyboardButton(text='Удалить➖', callback_data='franchise_delete_admin'))
admin_menu_franchise.row(InlineKeyboardButton(text='Назад⬅️', callback_data='back_main_menu_admin'))

#меню списков#
admin_menu_list=InlineKeyboardMarkup(row_width=1)
admin_menu_list.row(InlineKeyboardButton(text='Пользователи👥', callback_data='list_users_admin'))
...
admin_menu_text.row(InlineKeyboardButton(text='Франшиза', callback_data='chenneger_franchise_text_settings_admin'))
